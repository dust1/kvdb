...
impl TransactionMode {
    ...
    pub fn satisfies(&self, other: &TransactionMode) -> bool {
        match (self, other) {
            (TransactionMode::ReadWrite, TransactionMode::ReadOnly) => true,
            (TransactionMode::Snapshot { .. }, TransactionMode::ReadOnly) => true,
